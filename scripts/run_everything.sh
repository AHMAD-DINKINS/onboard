...
java -cp ./target/classes:./target/test-classes:$DAIKONDIR/daikon.jar:dependencies/junit-4.13.jar:dependencies/evosuite-standalone-runtime-1.1.1-SNAPSHOT.jar:dependencies/hamcrest-core-1.3.jar daikon.DynComp AppendPairProgram_ESTest

java -cp ./target/classes:./target/test-classes:$DAIKONDIR/daikon.jar:dependencies/junit-4.13.jar:dependencies/evosuite-standalone-runtime-1.1.1-SNAPSHOT.jar:dependencies/hamcrest-core-1.3.jar daikon.Chicory --comparability-file=AppendPairProgram_ESTest.decls-DynComp AppendPairProgram_ESTest
...
file="${file%.*}"
java -cp ./target/classes:./target/test-classes:$DAIKONDIR/daikon.jar:dependencies/junit-4.13.jar daikon.DynComp $file
java -cp ./target/classes:./target/test-classes:$DAIKONDIR/daikon.jar daikon.Chicory --comparability-file=$file.decls-DynComp $file
